...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="CustomerGridView" AlternatingRowStyle-BackColor="Wheat" CellPadding="3" CellSpacing="1" runat="server" PageSize="10" AllowPaging="true" AutoGenerateColumns="false" EmptyDataText="Nu se vede nimic" ForeColor="#333333" GridLines="None" OnRowUpdating="GridView1_RowUpdating" OnPageIndexChanging="GridView1_PageIndexChanging" OnSelectedIndexChanged="CustomerGridView_SelectedIndexChanged">
      ...
      <asp:Label runat="server" ID="lblCustomerID" Text='<%#Eval("CustomerID")%>'></asp:Label>
            ...
            <asp:GridView ID="gridviewSelectedCustomerRow" runat="server" HeaderStyle-BackColor="Tomato" HeaderStyle-ForeColor="Wheat" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <%--                    <asp:BoundField DataField="CustomerOrderID" HeaderText="CustomerOrderID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />--%>
<%--                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:HiddenField runat="server" Value='<%#Eval("CustomerOrderID")%>' />
                        </ItemTemplate>
                    </asp:TemplateField>--%>
                    ...
                    <%--                    <asp:BoundField DataField="orderedproduct.Name" HeaderText="Name"></asp:BoundField>
                    <asp:BoundField DataField="orderedproduct.Price" HeaderText="Price"></asp:BoundField>
                    <asp:BoundField DataField="orderedproduct.Description" HeaderText="Description"></asp:BoundField>
                    <asp:BoundField DataField="orderedproduct.Category" HeaderText="Category"></asp:BoundField>--%>
                </Columns>
            </asp:GridView>
            <ul id="addlistcss">
                <li>First name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
